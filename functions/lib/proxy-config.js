...
exports.isCdpMode = exports.CHROME_DEFAULT_ARGS = exports.CHROME_STEALTH_ARGS = exports.REMOTE_DEBUGGING_PORT = exports.CHROME_PERF_ARGS = exports.CHROME_SANDBOX_ARGS = exports.PORT = exports.auth = exports.db = void 0;
...
const isCdpMode = () => Boolean(LOCAL_CDP_URL);
exports.isCdpMode = isCdpMode;
    ...
    launchInProgress = (async () => {
        try {
            if (LOCAL_CDP_URL) {
                ...
                browserInstance = await playwright_1.chromium.connectOverCDP(LOCAL_CDP_URL);
