 ...
 * [Child Task/Issue] Sentinel Intel Modal
 * [Subtask] Intel dashboard displaying earnings, scholar, and memory persona data
 * [Upstream] AppTheme + earnings data -> [Downstream] Intel Modal UI
...
import { MemoryPersonaView } from './MemoryPersonaView';
import { ScholarModuleView } from './ScholarModuleView';
import { sentinelStyles as s } from './sentinel-intel.modal.styles';
