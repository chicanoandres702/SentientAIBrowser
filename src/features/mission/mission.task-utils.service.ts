 ...
 * [Child Task/Issue] Task utilities
 * [Subtask] Helper functions for mission task state management
 * [Upstream] Firestore missions collection -> [Downstream] Task operations
 * [Law Check] 35 lines | Passed 100-Line Law
 */
