...
export const styles = StyleSheet.create({
    ...
    headerText: { color: '#fff', fontSize: 10, fontWeight: '900', letterSpacing: 3, ...Platform.select({ web: { textShadow: '0 0 8px rgba(255,255,255,0.5)' } as any, default: { textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 8 } }) },
    statusDot: { width: 6, height: 6, borderRadius: 3, ...Platform.select({ web: { boxShadow: '0 0 4px rgba(255,255,255,0.8)' } as any, default: { shadowOffset: { width: 0, height: 0 }, shadowOpacity: 1, shadowRadius: 4 } }) },
