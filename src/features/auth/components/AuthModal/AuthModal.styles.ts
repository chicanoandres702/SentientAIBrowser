...
export const styles = StyleSheet.create({
    ...
    submitBtn: { 
        width: '100%', height: 50, borderRadius: 25, justifyContent: 'center', alignItems: 'center', marginTop: 10, elevation: 6,
        ...Platform.select({
            web: { boxShadow: '0px 5px 10px rgba(0,0,0,0.6)' } as any,
            default: { shadowOpacity: 0.6, shadowRadius: 10 }
        })
    },
