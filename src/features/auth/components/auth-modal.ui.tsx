    ...
    return (
        <View style={styles.overlay}>
            <View style={styles.modalBg}>
                ...
                <TouchableOpacity style={styles.googleBtn} onPress={loginWithGoogle} disabled={isLoading}><Text style={styles.googleText}>CONTINUE WITH GOOGLE</Text></TouchableOpacity>
