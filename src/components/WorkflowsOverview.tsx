// Feature: Browser UI | Why: Overview of all open browser workflows as interactive cards
import React from 'react';
import { View, Text, TouchableOpacity, ScrollView } from 'react-native';
import * as Animatable from 'react-native-animatable';
import { AppTheme } from '../../App';
import { uiColors } from '../features/ui/theme/ui.theme';
import { overviewStyles as s } from './WorkflowsOverview.styles';
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.grid}>
                {tabs.map((tab) => (
                    <TouchableOpacity
                        ...
                        activeOpacity={0.75}
                    >
                        {/* Top accent bar marks the active browser */}
                        ...
                        {/* Close = close that browser/workflow */}
                        {tabs.length > 1 && (
